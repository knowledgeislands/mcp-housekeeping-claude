...
Keep the tool catalogue in README and the practical instructions in `docs/guides/`, under the audience that needs them; keep shared repository guidance here and only Claude-specific deltas in CLAUDE.md.

Repository-specific implementation guidance follows. User-facing setup and tool documentation live in [README.md](./README.md) and [docs/guides/](./docs/guides/README.md).
